...
import { experiences } from "@/components/Tabs/data";
          ...
          >
            {experiences.map((exp) => (
              <Tab
                ...
                className={({ selected }) =>
                  classNames(
                    " sm:w-56 sm:border-l-[3px] relative sm:border-[#79759c1a] py-3 text-left sm:px-6 text-sm sm:text-base rounded-sm sm:hover:bg-[#2d2d44] hover:text-purpley",
