            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  facilitating the delivery of learning materials and resources
                  to students. Throughout the project, I utilized a diverse
                  range of languages and frameworks, including PHP, JavaScript,
                  Laravel, Node.js, and MySQL.
                </p>
          ...
          <li className="mb-12">
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  Implemented a smoke detection system that leveraged the power
                  of image processing, object detection.
            ...
            <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:col-span-6">
                ...
                <p className="mt-2 text-sm leading-normal">
                  ...
                  streamline and manage medical consultations. This application
                  enabled efficient scheduling, tracking, and documentation of
                  medical appointments. Throughout the development process, I
                  utilized a diverse range of languages, including PHP,
