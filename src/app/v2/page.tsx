              ...
              <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
                <div>
                  ...
                  <p className="mt-4 max-w-xs leading-normal">
                    My focus is on building engaging and functional experiences
                    for the web.
                  </p>
                  <NavigationLinks />
                </div>
                ...
                >
                  ...
                  <div>
                    <div className="mb-4 text-[0.975rem]">
                      ...
                      , I build websites and web applications. I possess a
                      comprehensive understanding of the entire web development
                      process, transforming design concepts into responsive
                      websites.{" "}
                      <p className="my-4">
                        Using Node.js and Express, I create robust server-side
                        logic. On the front-end, I utilize React and Next.js to
                        develop interactive user interfaces with efficient code.
                        I thrive in dynamic environments, collaborating with
                        cross-functional teams to bring projects from conception
                        to deployment.{" "}
                      </p>
                      <p>
                        Constantly staying updated with industry trends, I am
                        passionate about delivering engaging and scalable web
                        applications that meet client and user needs.
                      </p>
                    </div>
                  </div>
                </section>
                        ...
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              During my time as a freelancer on Fiverr, I
                              successfully developed over three full-stack web
                              applications catering to diverse domains, such as
                              Cryptocurrency and Fitness. I actively engaged
                              with various professionals, including Web
                      ...
                      <li className="mb-12">
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              I developed an E-learning platform for the ESTC
                              School, facilitating the delivery of learning
                              materials and resources to students. Throughout
                              the project, I utilized a diverse range of
                              languages and frameworks, including PHP,
                      ...
                      <li className="mb-12">
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              Implemented a smoke detection system that
                              leveraged the power of image processing, object
                              detection.
                              <br /> Using the Python programming language,
                              Through image processing techniques and object
                              detection algorithms, the system could identify
                              and track smoke in real-time.
                            </p>
                            <ul
                              className="mt-2 flex flex-wrap"
                              aria-label="Technologies used"
                      ...
                      <li className="mb-12">
                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              Developed a CRUD web application for OCP Group
                              Company to streamline and manage medical
                              consultations. This application enabled efficient
                              scheduling, tracking, and documentation of medical
                              appointments. Throughout the development process,
                              I utilized a diverse range of languages, including
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              As part of my freelance work, I developed a clone
                              of Foundation app as a reconstructed iteration of
                              the website{" "}
                              <Link
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              Glasnik is a highly interactive full stack web
                              that allows users to chat divided into communities
                              each of which has its own members and channels
                            </p>
                          </div>
                          <Image
                            alt="foundation app"
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              The Glasnik API is developed by leveraging a
                              powerful stack of technologies including Apollo
                              Server, Express, Prisma, Nexus, and PostgreSQL
                            </p>
                          </div>
                          <Image
                            alt="foundation app"
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              A website that informs you with the latest
                              Coronavirus stats of morocco: total and new cases
                              and current active cases and also interactive
                              graphs
                            </p>
                            <ul
                              className="mt-2 flex flex-wrap"
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              This is my internship report at GLOBAL-VISION
                              company namely the study and development of a
                              smoke detection application from a video sequence
                              or an image
                            </p>
                          </div>
                          <Image
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              Gestion d{"'"}absence is a system that manage
                              class attendance using face recognition in
                              real-time using Raspberry Pi model 3 B+
                            </p>
                      ...
                      <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                          ...
                          <div className="z-10 sm:order-2 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal">
                              During my initial internship project at OCP Group,
                              I built a PHP application that managed medical
                              consultations and helped streamlining.
                            </p>
